class Game {
  ...
  start() {
   ...
   var obstacle2Positions = [
    {x:width/2-120 , y:height - 4000 , image: obstacle2Image},
    {x:width/2-80 , y:height - 1500 , image: obstacle2Image},
    {x:width/2+140 , y:height - 2700 , image: obstacle2Image},
    {x:width/2+60 , y:height - 1756 , image: obstacle2Image},
